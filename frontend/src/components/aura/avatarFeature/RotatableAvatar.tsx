...
export function RotatableAvatar({ isThinking }: Props) {
=======
...
<<<<<<< HEAD
  const url = "/models/68904821e9fd634bec11abae.glb"; // replace with your avatar model URL
  //68904821e9fd634bec11abae.glb
=======
