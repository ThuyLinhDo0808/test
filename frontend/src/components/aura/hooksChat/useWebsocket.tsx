...
<<<<<<< HEAD
import { GreetingRef } from "./useEyeTracking";
export const isTTSPlayingRef: { current: boolean } = { current: false };
=======
>>>>>>> a3e73f24fdecda8ff20136cc16c840bbb297c079
...
<<<<<<< HEAD
  }, [setMessages, isAwaitingBotResponseRef]);
=======
  }, [setMessages]);
>>>>>>> a3e73f24fdecda8ff20136cc16c840bbb297c079
...
<<<<<<< HEAD
          if (GreetingRef.current) GreetingRef.current = false;// Reset greeting trigger
=======
>>>>>>> a3e73f24fdecda8ff20136cc16c840bbb297c079
          if (!trimmed) break;
...
<<<<<<< HEAD
    openModal, setResultData, setResultModalOpen, closeModal,
    setMessages, setIsThinking, isAwaitingBotResponseRef,
    playTTSChunk, stopTTSPlayback, handleFinalBotMessage, onBusyChange, updateLatestUserMessage
=======
