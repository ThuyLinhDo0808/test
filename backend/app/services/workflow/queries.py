...
<<<<<<< HEAD
        self.n_vector_retrieval = kwargs.get("n_vector_retrieval", 10)
=======
...
Rewritten Query:
<<<<<<< HEAD
"Availability of financial trading lab"
=======
...
Rewritten Query:
<<<<<<< HEAD
"Other labs available besides IT labs"
=======
...
User: Hi
Assistant: Welcome! How can I assist you?
User: I am handicapped and need wheelchair access, what entrance can I use to get into the building?

Rewritten Query:
"Entrance options for wheelchair access
=======
