...
<<<<<<< HEAD
        answer = AIMessage(content="I wasn't able to find any documents related to your question as no documents are in the system. Please try later when documents are added.")
=======
